...
var NextI18Next = __webpack_require__(3);
...
function (_React$Component) {
  ...
  _createClass(Title, [{
    ...
    value: function render() {
      return external_react_default.a.createElement("h1", null, external_react_default.a.createElement(i18n["Trans"], {
        i18nKey: "h1"
      }));
    }
  }]);
...
/* harmony default export */ var components_Title = (Object(i18n["withNamespaces"])('common')(Title_Title));
...
function (_React$Component) {
  ...
  Footer_createClass(Footer, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("footer", null, this.props.t('description'));
    }
  }]);
...
/* harmony default export */ var components_Footer = (Object(i18n["withNamespaces"])('footer')(Footer_Footer));
...
/*#__PURE__*/
function (_React$Component) {
  pages_inherits(Homepage, _React$Component);

  function Homepage() {
    pages_classCallCheck(this, Homepage);

    return pages_possibleConstructorReturn(this, pages_getPrototypeOf(Homepage).apply(this, arguments));
  }
  ...
  pages_createClass(Homepage, [{
    ...
    value: function render() {
      var t = this.props.t;
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(components_Title, null), external_react_default.a.createElement("button", {
        onClick: function onClick() {
          return i18n["i18n"].changeLanguage(i18n["i18n"].language === 'en' ? 'sv' : 'en');
        }
      }, t('change-locale')), external_react_default.a.createElement(i18n["Link"], {
        href: "/second-page"
      }, external_react_default.a.createElement("a", null, t('to-second-page'))), external_react_default.a.createElement(components_Footer, null));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (Object(i18n["withNamespaces"])('common')(pages_Homepage));

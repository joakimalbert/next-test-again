...
function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function componentDidMount() {
      ...
      console.log(firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.auth()); // To support email and phone number we need to validate if email first, then run the email login, otherwise use the /phone/login
      ...
      firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.auth().signInWithEmailAndPassword('joakim@hejalbert.se', '332625').then(function (res) {
        ...
        firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.database().ref('/users/' + nuid).once('value').then(function (snap) {
          if (snap.exists()) {
            var userdata = snap.val();
            firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.database().ref('/userData/' + nuid).once('value').then(function (p) {
              console.log(p);
            });
          }
        });
...
//# sourceMappingURL=_app.js.c79febaf398bc401d068.hot-update.js.map
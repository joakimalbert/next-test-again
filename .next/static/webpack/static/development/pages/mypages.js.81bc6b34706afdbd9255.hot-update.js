...
function (_React$Component) {
  ...
  function MyPages() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MyPages).apply(this, arguments));
  }

  _createClass(MyPages, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.initializeApp(firebaseConfig); // To support email and phone number we need to validate if email first, then run the email login, otherwise use the /phone/login
...
//# sourceMappingURL=mypages.js.81bc6b34706afdbd9255.hot-update.js.map